        ...
        <form className='flex flex-col gap-2'  onSubmit={(e)=>{
          ...
          if(id){
            ...
            <div className='flex flex-col gap-1'> 
              ...
              <input type="text" id='category-name' value={data?.name ?? ""} name='category-name' placeholder='Enter Name' className='border px-4 py-2 rounded-lg' onChange={(e)=>handelData('name',e.target.value)}/>
            </div>
            ...
            <div className='flex flex-col gap-1'> 
              ...
              <input type="text" id='category-slug' value={data?.slug ?? ""} name='category-slug' placeholder='Enter Slug' className='border px-4 py-2 rounded-lg' onChange={(e)=>handelData('slug',e.target.value)}/>
            </div>
